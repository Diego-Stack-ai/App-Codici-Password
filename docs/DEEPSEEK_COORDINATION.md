...
**Stato incarico: IN_LAVORAZIONE** — presa in carico 2026-09-17 22:15 (DeepSeek); commit osservato `1bd66d40`. Correggo il coordinamento del runner (uscita normale del browser dopo un endpoint già ricevuto), attendo e conto davvero Chrome ed Edge con fallimento se manca un esito, aggiungo una regressione deterministica sulla corsa endpoint/exit e rieseguo le prove prescritte. Nessuna modifica alla funzionalità Allegati, alla produzione, alla versione, a `master` o al deploy.
