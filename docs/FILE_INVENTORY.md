...
File censiti: **536**. Duplicati byte-per-byte: **1 gruppi**.

## tests

| File | Tipo | Byte | Righe | Responsabilità |
|---|---:|---:|---:|---|
| `tests/setup-linux-cloud.test.mjs` | MJS | 3752 | 73 | Test automatico: setup-linux-cloud.test. |
...
| `Frontend/GUIDA_AGGIORNAMENTI.md` | MD | 74551 | 719 | Documentazione: GUIDA AGGIORNAMENTI. |
...
| `docs/AUDIT_VAULT_SESSION_P0.md` | MD | 124985 | 705 | Documentazione: AUDIT VAULT SESSION P0. |
...
| `docs/M6_SINCRONIZZAZIONE_OFFLINE.md` | MD | 35678 | 228 | Documentazione: M6 SINCRONIZZAZIONE OFFLINE. |
...
| `docs/PIANO_MATURITA_PROFESSIONALE.md` | MD | 35613 | 411 | Documentazione: PIANO MATURITA PROFESSIONALE. |
...
| `docs/SETUP_LINUX_CLOUD.md` | MD | 3942 | 44 | Documentazione: SETUP LINUX CLOUD. |
...
| `experiments/offline-sync/browser-backend-sync.mjs` | MJS | 15411 | 187 | File di progetto: browser-backend-sync. |
...
| `experiments/offline-sync/fenced-queue-client.mjs` | MJS | 4823 | 79 | File di progetto: fenced-queue-client. |
...
| `experiments/offline-sync/offline-save-panel.mjs` | MJS | 15253 | 210 | File di progetto: offline-save-panel. |
| `experiments/offline-sync/offline-save-panel.test.mjs` | MJS | 13930 | 225 | File di progetto: offline-save-panel.test. |
| `experiments/offline-sync/run-browser-tests.mjs` | MJS | 5306 | 76 | File di progetto: run-browser-tests. |
...
| File | Tipo | Byte | Righe | Responsabilità |
|---|---:|---:|---:|---|
| `package.json` | JSON | 9281 | 84 | Comandi di audit, test e versione; dipendenze di sviluppo della radice. |
...
| `scripts/setup-linux-cloud.sh` | SH | 4014 | 92 | Strumento manutenzione/test: setup-linux-cloud. |
