...
File censiti: **721**. Duplicati byte-per-byte: **1 gruppi**.
...
| `Frontend/GUIDA_AGGIORNAMENTI.md` | MD | 137234 | 1007 | Documentazione: GUIDA AGGIORNAMENTI. |
...
| `docs/DEEPSEEK_COORDINATION.md` | MD | 74954 | 413 | Documentazione: DEEPSEEK COORDINATION. |
...
| `docs/PIANO_MATURITA_PROFESSIONALE.md` | MD | 97992 | 674 | Documentazione: PIANO MATURITA PROFESSIONALE. |
| `docs/PROFILO_ACCOUNT_WIDGET_CACHE_ROADMAP.md` | MD | 120219 | 710 | Documentazione: PROFILO ACCOUNT WIDGET CACHE ROADMAP. |
...
| `experiments/persistent-vault-shell/company-contacts-editor-view.mjs` | MJS | 15125 | 242 | File di progetto: company-contacts-editor-view. |
| `experiments/persistent-vault-shell/company-contacts-editor.test.mjs` | MJS | 14703 | 226 | File di progetto: company-contacts-editor.test. |
...
| File | Tipo | Byte | Righe | Responsabilità |
|---|---:|---:|---:|---|
| `package.json` | JSON | 14870 | 98 | Comandi di audit, test e versione; dipendenze di sviluppo della radice. |
...
| `scripts/run-vault-session-emulators.mjs` | MJS | 4126 | 36 | Strumento manutenzione/test: run-vault-session-emulators. |
