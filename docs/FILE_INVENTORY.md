...
File censiti: **780**. Duplicati byte-per-byte: **1 gruppi**.
...
| `docs/DEEPSEEK_COORDINATION.md` | MD | 177961 | 914 | Documentazione: DEEPSEEK COORDINATION. |
...
| `experiments/offline-sync/run-browser-tests.mjs` | MJS | 7137 | 95 | File di progetto: run-browser-tests. |
| `experiments/offline-sync/run-emulated-browsers.mjs` | MJS | 1273 | 22 | File di progetto: run-emulated-browsers. |
...
| `experiments/persistent-vault-shell/account-standard-candidate-rules.mjs` | MJS | 1040 | 19 | File di progetto: account-standard-candidate-rules. |
| `experiments/persistent-vault-shell/account-standard-contract.mjs` | MJS | 4657 | 51 | File di progetto: account-standard-contract. |
| `experiments/persistent-vault-shell/account-standard-editor-provider.mjs` | MJS | 1706 | 20 | File di progetto: account-standard-editor-provider. |
| `experiments/persistent-vault-shell/account-standard-editor-source.mjs` | MJS | 3446 | 41 | File di progetto: account-standard-editor-source. |
| `experiments/persistent-vault-shell/account-standard-editor-view.mjs` | MJS | 2759 | 35 | File di progetto: account-standard-editor-view. |
| `experiments/persistent-vault-shell/account-standard-editor.test.mjs` | MJS | 4501 | 39 | File di progetto: account-standard-editor.test. |
| `experiments/persistent-vault-shell/account-standard-handler.mjs` | MJS | 2811 | 39 | File di progetto: account-standard-handler. |
| `experiments/persistent-vault-shell/account-standard.test.mjs` | MJS | 5440 | 54 | File di progetto: account-standard.test. |
...
| `experiments/persistent-vault-shell/docs/A5_CREAZIONE_ACCOUNT_DAL_COLLEGAMENTO.md` | MD | 2654 | 14 | Documentazione: A5 CREAZIONE ACCOUNT DAL COLLEGAMENTO. |
| `experiments/persistent-vault-shell/docs/A6_EDITOR_CREDENZIALI_STANDARD.md` | MD | 2612 | 24 | Documentazione: A6 EDITOR CREDENZIALI STANDARD. |
| `experiments/persistent-vault-shell/emulator-addresses-check.mjs` | MJS | 30485 | 354 | File di progetto: emulator-addresses-check. |
...
| `experiments/persistent-vault-shell/emulator-browser.mjs` | MJS | 15225 | 169 | File di progetto: emulator-browser. |
...
| `experiments/persistent-vault-shell/emulator-detail-view.mjs` | MJS | 7319 | 134 | File di progetto: emulator-detail-view. |
...
| `experiments/persistent-vault-shell/emulator-entry-check.mjs` | MJS | 42739 | 508 | File di progetto: emulator-entry-check. |
...
| `experiments/persistent-vault-shell/emulator-entry.mjs` | MJS | 29422 | 344 | File di progetto: emulator-entry. |
...
| `experiments/persistent-vault-shell/emulator-qr-bridge.mjs` | MJS | 5902 | 75 | File di progetto: emulator-qr-bridge. |
...
| `experiments/persistent-vault-shell/firebase-documents.test.mjs` | MJS | 3211 | 4 | File di progetto: firebase-documents.test. |
...
| `experiments/persistent-vault-shell/firebase-profile-link.test.mjs` | MJS | 8684 | 98 | File di progetto: firebase-profile-link.test. |
...
| `experiments/persistent-vault-shell/offline-consultation-probe.mjs` | MJS | 4903 | 62 | File di progetto: offline-consultation-probe. |
...
| `experiments/persistent-vault-shell/prepare-private-documents.mjs` | MJS | 2316 | 13 | File di progetto: prepare-private-documents. |
| `experiments/persistent-vault-shell/prepare-private-utilities.mjs` | MJS | 4758 | 81 | File di progetto: prepare-private-utilities. |
| `experiments/persistent-vault-shell/prepare-profile-account-create.mjs` | MJS | 3263 | 37 | File di progetto: prepare-profile-account-create. |
...
| `experiments/persistent-vault-shell/private-documents-candidate-rules.mjs` | MJS | 578 | 4 | File di progetto: private-documents-candidate-rules. |
| `experiments/persistent-vault-shell/private-documents-contract.mjs` | MJS | 5742 | 52 | File di progetto: private-documents-contract. |
| `experiments/persistent-vault-shell/private-documents-editor-provider.mjs` | MJS | 954 | 3 | File di progetto: private-documents-editor-provider. |
| `experiments/persistent-vault-shell/private-documents-editor-source.mjs` | MJS | 3756 | 16 | File di progetto: private-documents-editor-source. |
| `experiments/persistent-vault-shell/private-documents-editor-view.mjs` | MJS | 4822 | 10 | File di progetto: private-documents-editor-view. |
| `experiments/persistent-vault-shell/private-documents-editor.test.mjs` | MJS | 2929 | 8 | File di progetto: private-documents-editor.test. |
| `experiments/persistent-vault-shell/private-documents-handler.mjs` | MJS | 2793 | 11 | File di progetto: private-documents-handler. |
| `experiments/persistent-vault-shell/private-documents.test.mjs` | MJS | 5679 | 18 | File di progetto: private-documents.test. |
...
| `experiments/persistent-vault-shell/profile-account-create-contract.mjs` | MJS | 2786 | 36 | File di progetto: profile-account-create-contract. |
| `experiments/persistent-vault-shell/profile-account-create-handler.mjs` | MJS | 4927 | 48 | File di progetto: profile-account-create-handler. |
| `experiments/persistent-vault-shell/profile-account-create-view.mjs` | MJS | 4169 | 36 | File di progetto: profile-account-create-view. |
| `experiments/persistent-vault-shell/profile-account-create.test.mjs` | MJS | 8915 | 97 | File di progetto: profile-account-create.test. |
...
| `experiments/persistent-vault-shell/profile-account-picker-view.mjs` | MJS | 5645 | 69 | File di progetto: profile-account-picker-view. |
| `experiments/persistent-vault-shell/profile-account-picker.test.mjs` | MJS | 10621 | 128 | File di progetto: profile-account-picker.test. |
...
| `experiments/persistent-vault-shell/profile-link-editor-provider.mjs` | MJS | 6933 | 92 | File di progetto: profile-link-editor-provider. |
...
| `experiments/persistent-vault-shell/profile-shell-view.mjs` | MJS | 14973 | 204 | File di progetto: profile-shell-view. |
