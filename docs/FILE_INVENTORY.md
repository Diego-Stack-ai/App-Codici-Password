...
File censiti: **682**. Duplicati byte-per-byte: **1 gruppi**.

## experiments

| File | Tipo | Byte | Righe | Responsabilità |
|---|---:|---:|---:|---|
| `experiments/persistent-vault-shell/firebase-profile-contacts.test.mjs` | MJS | 8453 | 106 | File di progetto: firebase-profile-contacts.test. |
...
| `experiments/persistent-vault-shell/profile-contacts-editor-source.mjs` | MJS | 6740 | 101 | File di progetto: profile-contacts-editor-source. |
| `experiments/persistent-vault-shell/profile-contacts-editor-view.mjs` | MJS | 10319 | 162 | File di progetto: profile-contacts-editor-view. |
| `experiments/persistent-vault-shell/profile-contacts-editor.test.mjs` | MJS | 15182 | 237 | File di progetto: profile-contacts-editor.test. |
| `experiments/persistent-vault-shell/profile-contacts-handler.mjs` | MJS | 5676 | 88 | File di progetto: profile-contacts-handler. |
| `experiments/persistent-vault-shell/profile-contacts.test.mjs` | MJS | 17977 | 260 | File di progetto: profile-contacts.test. |
...
| `experiments/persistent-vault-shell/emulator-entry-check.mjs` | MJS | 36928 | 442 | File di progetto: emulator-entry-check. |
| `experiments/persistent-vault-shell/emulator-entry-runner.mjs` | MJS | 5034 | 70 | File di progetto: emulator-entry-runner. |
| `experiments/persistent-vault-shell/emulator-entry.mjs` | MJS | 23323 | 279 | File di progetto: emulator-entry. |
...
| `experiments/persistent-vault-shell/emulator-qr-bridge.mjs` | MJS | 4462 | 61 | File di progetto: emulator-qr-bridge. |
...
| `Frontend/GUIDA_AGGIORNAMENTI.md` | MD | 123089 | 993 | Documentazione: GUIDA AGGIORNAMENTI. |
...
| `docs/PIANO_MATURITA_PROFESSIONALE.md` | MD | 81719 | 638 | Documentazione: PIANO MATURITA PROFESSIONALE. |
| `docs/PROFILO_ACCOUNT_WIDGET_CACHE_ROADMAP.md` | MD | 104459 | 674 | Documentazione: PROFILO ACCOUNT WIDGET CACHE ROADMAP. |
...
| File | Tipo | Byte | Righe | Responsabilità |
|---|---:|---:|---:|---|
| `package.json` | JSON | 13346 | 94 | Comandi di audit, test e versione; dipendenze di sviluppo della radice. |
