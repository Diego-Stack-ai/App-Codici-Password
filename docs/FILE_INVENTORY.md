...
File censiti: **709**. Duplicati byte-per-byte: **1 gruppi**.

## experiments

| File | Tipo | Byte | Righe | Responsabilità |
|---|---:|---:|---:|---|
| `experiments/persistent-vault-shell/emulator-entry-runner.test.mjs` | MJS | 2905 | 54 | File di progetto: emulator-entry-runner.test. |
...
| `experiments/persistent-vault-shell/emulator-entry-runner.mjs` | MJS | 5799 | 82 | File di progetto: emulator-entry-runner. |
...
| `experiments/persistent-vault-shell/emulator-network-control.mjs` | MJS | 6163 | 90 | File di progetto: emulator-network-control. |
...
| `Frontend/GUIDA_AGGIORNAMENTI.md` | MD | 134989 | 1005 | Documentazione: GUIDA AGGIORNAMENTI. |
...
| `docs/DEEPSEEK_COORDINATION.md` | MD | 57347 | 321 | Documentazione: DEEPSEEK COORDINATION. |
...
| File | Tipo | Byte | Righe | Responsabilità |
|---|---:|---:|---:|---|
| `package.json` | JSON | 14498 | 97 | Comandi di audit, test e versione; dipendenze di sviluppo della radice. |
