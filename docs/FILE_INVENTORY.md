...
File censiti: **354**. Duplicati byte-per-byte: **1 gruppi**.

## Frontend

| File | Tipo | Byte | Righe | Responsabilità |
|---|---:|---:|---:|---|
| `Frontend/public/assets/js/modules/settings/backup-import-model.js` | JS | 1438 | 37 | Impostazioni applicative: backup-import-model. |
| `Frontend/public/assets/js/modules/settings/backup-import-service.js` | JS | 5561 | 124 | Impostazioni applicative: backup-import-service. |
...
| `Frontend/public/assets/js/modules/azienda/dettaglio_account_azienda.js` | JS | 13461 | 348 | Flusso aziende/account aziendali: dettaglio account azienda. |
...
| `Frontend/public/assets/js/modules/core/security-manager.js` | JS | 23255 | 561 | Orchestrazione Master Password, envelope Vault e sblocco biometrico. |
...
| `Frontend/public/assets/js/modules/data/offline-mutation-client-core.js` | JS | 1187 | 33 | Supporto frontend: offline-mutation-client-core. |
| `Frontend/public/assets/js/modules/data/offline-mutation-client.js` | JS | 970 | 20 | Supporto frontend: offline-mutation-client. |
...
| `Frontend/public/assets/js/modules/privato/account_privati.js` | JS | 12190 | 303 | Flusso profilo/account personali: account privati. |
...
| `Frontend/public/assets/js/modules/privato/dettaglio_account_privato.js` | JS | 12430 | 310 | Flusso profilo/account personali: dettaglio account privato. |
| `Frontend/public/assets/js/modules/privato/form-privato-save.js` | JS | 14722 | 293 | Flusso profilo/account personali: form-privato-save. |
| `Frontend/public/assets/js/modules/privato/form_account_privato.js` | JS | 22032 | 531 | Flusso profilo/account personali: form account privato. |
...
| `Frontend/public/assets/js/modules/privato/profilo-dashboard.js` | JS | 9320 | 155 | Flusso profilo/account personali: profilo-dashboard. |
...
| `Frontend/public/assets/js/modules/settings/impostazioni.js` | JS | 32765 | 678 | Impostazioni applicative: impostazioni. |
...
| `Frontend/public/impostazioni.html` | HTML | 28526 | 483 | Struttura della pagina impostazioni; comportamento demandato ai moduli. |
...
| `Frontend/public/offline-assets.js` | JS | 8742 | 213 | File di progetto: offline-assets. |
...
| File | Tipo | Byte | Righe | Responsabilità |
|---|---:|---:|---:|---|
| `tests/backup-import-model.test.mjs` | MJS | 1565 | 27 | Test automatico: backup-import-model.test. |
...
| `tests/offline-mutation-client.test.mjs` | MJS | 2331 | 44 | Test automatico: offline-mutation-client.test. |
...
| `docs/M10_HARDENING_RILASCIO.md` | MD | 2430 | 33 | Documentazione: M10 HARDENING RILASCIO. |
...
| `docs/M8_BACKUP_RECUPERO.md` | MD | 2900 | 31 | Documentazione: M8 BACKUP RECUPERO. |
...
| `docs/PIANO_MATURITA_PROFESSIONALE.md` | MD | 18419 | 302 | Documentazione: PIANO MATURITA PROFESSIONALE. |
...
| File | Tipo | Byte | Righe | Responsabilità |
|---|---:|---:|---:|---|
| `firebase.json` | JSON | 3809 | 131 | Configura Hosting, header di sicurezza, emulatori, Firestore, Storage e Functions. |
...
| `functions/backup-restore-service.js` | JS | 4797 | 123 | File di progetto: backup-restore-service. |
...
| `functions/index.js` | JS | 68385 | 1354 | Backend MFA recovery, inviti, email, push e scheduler delle scadenze. |
...
| `functions/test/backup-restore-service.test.js` | JS | 2891 | 55 | Test automatico: backup-restore-service.test. |
...
| File | Tipo | Byte | Righe | Responsabilità |
|---|---:|---:|---:|---|
| `package.json` | JSON | 5708 | 73 | Comandi di audit, test e versione; dipendenze di sviluppo della radice. |
...
| `scripts/audit-release-hardening.mjs` | MJS | 1736 | 30 | Strumento manutenzione/test: audit-release-hardening. |
