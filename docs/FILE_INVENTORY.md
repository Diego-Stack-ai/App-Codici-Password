...
File censiti: **365**. Duplicati byte-per-byte: **1 gruppi**.

## docs

| File | Tipo | Byte | Righe | Responsabilità |
|---|---:|---:|---:|---|
| `docs/AGENTE_CODEX_EVOLUZIONE.md` | MD | 13883 | 207 | Documentazione: AGENTE CODEX EVOLUZIONE. |
| `docs/APP_ARCHITECTURE_AUDIT.md` | MD | 8110 | 119 | Documentazione: APP ARCHITECTURE AUDIT. |
...
| `docs/M10_HARDENING_RILASCIO.md` | MD | 3607 | 41 | Documentazione: M10 HARDENING RILASCIO. |
...
| `docs/M6_SINCRONIZZAZIONE_OFFLINE.md` | MD | 6337 | 67 | Documentazione: M6 SINCRONIZZAZIONE OFFLINE. |
| `docs/M7_CRONOLOGIA_CESTINO_AUDIT.md` | MD | 1804 | 27 | Documentazione: M7 CRONOLOGIA CESTINO AUDIT. |
| `docs/M8_BACKUP_RECUPERO.md` | MD | 4091 | 34 | Documentazione: M8 BACKUP RECUPERO. |
| `docs/M9_SALUTE_CREDENZIALI.md` | MD | 2795 | 31 | Documentazione: M9 SALUTE CREDENZIALI. |
...
| `docs/PIANO_MATURITA_PROFESSIONALE.md` | MD | 18816 | 302 | Documentazione: PIANO MATURITA PROFESSIONALE. |
| `docs/RISPOSTA_INCIDENTI_E_RECUPERO.md` | MD | 1164 | 18 | Documentazione: RISPOSTA INCIDENTI E RECUPERO. |
...
| `Frontend/public/assets/css/accesso.css` | CSS | 12277 | 551 | Stili della sezione accesso. |
...
| `Frontend/public/assets/css/account_form.css` | CSS | 19318 | 914 | Stili della sezione account form. |
...
| `Frontend/public/assets/css/core_ui.css` | CSS | 20187 | 821 | Stili della sezione core ui. |
...
| `Frontend/public/assets/css/impostazioni.css` | CSS | 22387 | 1015 | Stili della sezione impostazioni. |
| `Frontend/public/assets/css/lista_aziende.css` | CSS | 5551 | 260 | Stili della sezione lista aziende. |
| `Frontend/public/assets/css/moduli.css` | CSS | 12696 | 481 | Stili della sezione moduli. |
| `Frontend/public/assets/css/privacy.css` | CSS | 5177 | 242 | Stili della sezione privacy. |
| `Frontend/public/assets/css/profilo_privato.css` | CSS | 30537 | 1240 | Stili della sezione profilo privato. |
...
| `Frontend/public/assets/js/auth.js` | JS | 12481 | 314 | Registrazione, login, TOTP, logout e reset account Firebase Auth. |
...
| `Frontend/public/assets/js/firebase-config.js` | JS | 2988 | 76 | Singleton Firebase e cache Firestore persistente multi-tab. |
| `Frontend/public/assets/js/footer-state.js` | JS | 571 | 19 | Supporto frontend: footer-state. |
| `Frontend/public/assets/js/home-bootstrap.js` | JS | 722 | 20 | Supporto frontend: home-bootstrap. |
...
| `Frontend/public/assets/js/main-v129.js` | JS | 32121 | 591 | Bootstrap autenticato globale, router, inviti e notifiche. |
...
| `Frontend/public/assets/js/modules/auth/login.js` | JS | 14061 | 340 | Flusso autenticazione: login. |
...
| `Frontend/public/assets/js/modules/azienda/account_azienda.js` | JS | 7563 | 199 | Flusso aziende/account aziendali: account azienda. |
| `Frontend/public/assets/js/modules/azienda/company-list-service.js` | JS | 412 | 11 | Flusso aziende/account aziendali: company-list-service. |
...
| `Frontend/public/assets/js/modules/azienda/dettaglio_account_azienda.js` | JS | 14114 | 359 | Flusso aziende/account aziendali: dettaglio account azienda. |
| `Frontend/public/assets/js/modules/azienda/form-azienda-save.js` | JS | 15629 | 307 | Flusso aziende/account aziendali: form-azienda-save. |
...
| `Frontend/public/assets/js/modules/azienda/lista_aziende.js` | JS | 10015 | 265 | Flusso aziende/account aziendali: lista aziende. |
| `Frontend/public/assets/js/modules/azienda/ma_attachments.js` | JS | 2731 | 70 | Flusso aziende/account aziendali: ma attachments. |
| `Frontend/public/assets/js/modules/azienda/ma_cards.js` | JS | 15738 | 327 | Flusso aziende/account aziendali: ma cards. |
| `Frontend/public/assets/js/modules/azienda/ma_save.js` | JS | 10828 | 190 | Flusso aziende/account aziendali: ma save. |
...
| `Frontend/public/assets/js/modules/azienda/modifica_azienda.js` | JS | 3925 | 95 | Flusso aziende/account aziendali: modifica azienda. |
| `Frontend/public/assets/js/modules/core/crypto-utils.js` | JS | 11911 | 322 | Primitive KDF, AES-GCM, verifier e codifiche crittografiche. |
| `Frontend/public/assets/js/modules/core/mfa-manager.js` | JS | 4797 | 108 | Enroll, rimozione, recupero e revoca sessioni TOTP. |
| `Frontend/public/assets/js/modules/core/password-policy.js` | JS | 3154 | 76 | Supporto frontend: password-policy. |
| `Frontend/public/assets/js/modules/core/security-manager.js` | JS | 23552 | 566 | Orchestrazione Master Password, envelope Vault e sblocco biometrico. |
...
| `Frontend/public/assets/js/modules/data/offline-mutation-client-core.js` | JS | 1390 | 38 | Supporto frontend: offline-mutation-client-core. |
| `Frontend/public/assets/js/modules/data/offline-mutation-client.js` | JS | 995 | 20 | Supporto frontend: offline-mutation-client. |
...
| `Frontend/public/assets/js/modules/data/private-account-offline-pilot.js` | JS | 3139 | 104 | Supporto frontend: private-account-offline-pilot. |
...
| `Frontend/public/assets/js/modules/data/vault-repository.js` | JS | 7808 | 142 | Supporto frontend: vault-repository. |
...
| `Frontend/public/assets/js/modules/privato/account_privati.js` | JS | 13066 | 325 | Flusso profilo/account personali: account privati. |
| `Frontend/public/assets/js/modules/privato/area_privata.js` | JS | 21474 | 514 | Flusso profilo/account personali: area privata. |
| `Frontend/public/assets/js/modules/privato/dettaglio-privato-attachments.js` | JS | 8867 | 234 | Flusso profilo/account personali: dettaglio-privato-attachments. |
...
| `Frontend/public/assets/js/modules/privato/dettaglio_account_privato.js` | JS | 13106 | 325 | Flusso profilo/account personali: dettaglio account privato. |
| `Frontend/public/assets/js/modules/privato/form-privato-save.js` | JS | 19189 | 385 | Flusso profilo/account personali: form-privato-save. |
| `Frontend/public/assets/js/modules/privato/form_account_privato.js` | JS | 31288 | 708 | Flusso profilo/account personali: form account privato. |
| `Frontend/public/assets/js/modules/privato/private-account-offline-policy.js` | JS | 599 | 17 | Flusso profilo/account personali: private-account-offline-policy. |
| `Frontend/public/assets/js/modules/privato/profile-model.js` | JS | 4696 | 102 | Flusso profilo/account personali: profile-model. |
| `Frontend/public/assets/js/modules/privato/profilo-actions.js` | JS | 12065 | 242 | Flusso profilo/account personali: profilo-actions. |
| `Frontend/public/assets/js/modules/privato/profilo-addresses-docs.js` | JS | 17036 | 279 | Flusso profilo/account personali: profilo-addresses-docs. |
| `Frontend/public/assets/js/modules/privato/profilo-dashboard.js` | JS | 9675 | 166 | Flusso profilo/account personali: profilo-dashboard. |
| `Frontend/public/assets/js/modules/privato/profilo-links.js` | JS | 3518 | 65 | Flusso profilo/account personali: profilo-links. |
...
| `Frontend/public/assets/js/modules/privato/profilo_privato.js` | JS | 23466 | 494 | Flusso profilo/account personali: profilo privato. |
...
| `Frontend/public/assets/js/modules/scadenze/configurazione_generali.js` | JS | 14321 | 333 | Flusso scadenze/configurazione: configurazione generali. |
...
| `Frontend/public/assets/js/modules/settings/archivio_account.js` | JS | 10824 | 306 | Impostazioni applicative: archivio account. |
...
| `Frontend/public/assets/js/modules/settings/backup-export-service.js` | JS | 5811 | 124 | Impostazioni applicative: backup-export-service. |
| `Frontend/public/assets/js/modules/settings/backup-import-model.js` | JS | 5667 | 119 | Impostazioni applicative: backup-import-model. |
| `Frontend/public/assets/js/modules/settings/backup-import-service.js` | JS | 7152 | 147 | Impostazioni applicative: backup-import-service. |
| `Frontend/public/assets/js/modules/settings/credential-health-model.js` | JS | 2522 | 68 | Impostazioni applicative: credential-health-model. |
| `Frontend/public/assets/js/modules/settings/credential-health-service.js` | JS | 4594 | 122 | Impostazioni applicative: credential-health-service. |
| `Frontend/public/assets/js/modules/settings/impostazioni.js` | JS | 45457 | 927 | Impostazioni applicative: impostazioni. |
...
| `Frontend/public/assets/js/modules/shared/banking-model.js` | JS | 2551 | 79 | Supporto frontend: banking-model. |
| `Frontend/public/assets/js/modules/shared/banking-renderer.js` | JS | 9959 | 193 | Renderer condiviso per conti bancari e carte. |
...
| `Frontend/public/assets/js/modules/shared/detail-account-mode.js` | JS | 10319 | 185 | Supporto frontend: detail-account-mode. |
...
| `Frontend/public/assets/js/modules/shared/qr_code_utils-v2.js` | JS | 6487 | 139 | Supporto frontend: qr code utils-v2. |
...
| `Frontend/public/assets/js/ui-core-v129.js` | JS | 19790 | 457 | Toast, modali, input protetti e componenti UI globali. |
...
| `Frontend/public/dettaglio_account_azienda.html` | HTML | 25024 | 391 | Struttura della pagina dettaglio account azienda; comportamento demandato ai moduli. |
| `Frontend/public/dettaglio_account_privato.html` | HTML | 22145 | 357 | Struttura della pagina dettaglio account privato; comportamento demandato ai moduli. |
...
| `Frontend/public/impostazioni.html` | HTML | 29340 | 496 | Struttura della pagina impostazioni; comportamento demandato ai moduli. |
...
| `Frontend/public/login-v115.html` | HTML | 8113 | 166 | Struttura della pagina login-v115; comportamento demandato ai moduli. |
...
| `Frontend/public/offline-assets.js` | JS | 8988 | 217 | File di progetto: offline-assets. |
| `Frontend/public/privacy.html` | HTML | 13804 | 262 | Struttura della pagina privacy; comportamento demandato ai moduli. |
| `Frontend/public/profilo_privato.html` | HTML | 15823 | 262 | Struttura della pagina profilo privato; comportamento demandato ai moduli. |
...
| `functions/archive-purge-service.js` | JS | 2660 | 65 | File di progetto: archive-purge-service. |
| `functions/backup-restore-service.js` | JS | 5051 | 128 | File di progetto: backup-restore-service. |
...
| `functions/index.js` | JS | 70913 | 1407 | Backend MFA recovery, inviti, email, push e scheduler delle scadenze. |
...
| `functions/private-account-mutation-service.js` | JS | 3215 | 66 | File di progetto: private-account-mutation-service. |
| `functions/recovery-security.js` | JS | 1887 | 54 | Generazione, hash e rate-limit dei codici MFA di recupero. |
| `functions/test/archive-purge-service.test.js` | JS | 2802 | 46 | Test automatico: archive-purge-service.test. |
| `functions/test/backup-restore-service.test.js` | JS | 3433 | 63 | Test automatico: backup-restore-service.test. |
...
| File | Tipo | Byte | Righe | Responsabilità |
|---|---:|---:|---:|---|
| `package-lock.json` | JSON | 442758 | 12562 | Lockfile riproducibile delle dipendenze npm. |

## package.json

| File | Tipo | Byte | Righe | Responsabilità |
|---|---:|---:|---:|---|
| `package.json` | JSON | 5795 | 73 | Comandi di audit, test e versione; dipendenze di sviluppo della radice. |
...
| `scripts/audit-security-flows.mjs` | MJS | 32969 | 286 | Strumento manutenzione/test: audit-security-flows. |
...
| `scripts/run-firestore-rules-tests.mjs` | MJS | 1154 | 27 | Strumento manutenzione/test: run-firestore-rules-tests. |
...
| `tests/backup-import-model.test.mjs` | MJS | 3094 | 56 | Test automatico: backup-import-model.test. |
| `tests/banking-model.test.mjs` | MJS | 2650 | 63 | Test automatico: banking-model.test. |
| `tests/credential-health-runtime.test.mjs` | MJS | 2834 | 60 | Test automatico: credential-health-runtime.test. |
...
| `tests/offline-mutation-client.test.mjs` | MJS | 2597 | 54 | Test automatico: offline-mutation-client.test. |
| `tests/offline-mutation-queue.test.mjs` | MJS | 2560 | 51 | Test automatico: offline-mutation-queue.test. |
| `tests/offline-mutation-sync.test.mjs` | MJS | 2992 | 57 | Test automatico: offline-mutation-sync.test. |
...
| `tests/profile-model.test.mjs` | MJS | 4313 | 79 | Test automatico: profile-model.test. |
...
| `tests/sharing-two-device.test.mjs` | MJS | 2034 | 39 | Test automatico: sharing-two-device.test. |
