...
File censiti: **529**. Duplicati byte-per-byte: **1 gruppi**.
...
| `docs/AUDIT_VAULT_SESSION_P0.md` | MD | 119847 | 671 | Documentazione: AUDIT VAULT SESSION P0. |
...
| `docs/M6_SINCRONIZZAZIONE_OFFLINE.md` | MD | 28662 | 192 | Documentazione: M6 SINCRONIZZAZIONE OFFLINE. |
...
| `docs/PIANO_MATURITA_PROFESSIONALE.md` | MD | 33827 | 401 | Documentazione: PIANO MATURITA PROFESSIONALE. |
...
| `experiments/offline-sync/browser-backend-sync.mjs` | MJS | 10838 | 138 | File di progetto: browser-backend-sync. |
...
| `experiments/offline-sync/offline-save-panel.mjs` | MJS | 5058 | 76 | File di progetto: offline-save-panel. |
| `experiments/offline-sync/offline-save-panel.test.mjs` | MJS | 4442 | 88 | File di progetto: offline-save-panel.test. |
| `experiments/offline-sync/run-browser-tests.mjs` | MJS | 4838 | 72 | File di progetto: run-browser-tests. |
...
| `experiments/persistent-vault-shell/emulator-detail-view.mjs` | MJS | 5460 | 110 | File di progetto: emulator-detail-view. |
| `experiments/persistent-vault-shell/emulator-detail-view.test.mjs` | MJS | 14505 | 248 | File di progetto: emulator-detail-view.test. |
