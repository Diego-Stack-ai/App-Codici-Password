...
File censiti: **523**. Duplicati byte-per-byte: **1 gruppi**.

## experiments

| File | Tipo | Byte | Righe | Responsabilità |
|---|---:|---:|---:|---|
| `experiments/offline-sync/fenced-queue-writer.mjs` | MJS | 6308 | 93 | File di progetto: fenced-queue-writer. |
...
| `experiments/offline-sync/browser-coordination.mjs` | MJS | 10846 | 154 | File di progetto: browser-coordination. |
...
| `experiments/offline-sync/run-browser-tests.mjs` | MJS | 3923 | 64 | File di progetto: run-browser-tests. |
...
| `docs/AUDIT_VAULT_SESSION_P0.md` | MD | 117527 | 647 | Documentazione: AUDIT VAULT SESSION P0. |
...
| `docs/M6_SINCRONIZZAZIONE_OFFLINE.md` | MD | 20503 | 148 | Documentazione: M6 SINCRONIZZAZIONE OFFLINE. |
...
| `docs/PIANO_MATURITA_PROFESSIONALE.md` | MD | 31960 | 389 | Documentazione: PIANO MATURITA PROFESSIONALE. |
