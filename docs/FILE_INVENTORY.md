...
File censiti: **617**. Duplicati byte-per-byte: **27 gruppi**.
...
| `Frontend/GUIDA_AGGIORNAMENTI.md` | MD | 99854 | 894 | Documentazione: GUIDA AGGIORNAMENTI. |
| `Frontend/GUIDA_AGGIORNAMENTI.md` | MD | 99854 | 894 | Documentazione: GUIDA AGGIORNAMENTI. |
| `Frontend/GUIDA_AGGIORNAMENTI.md` | MD | 99854 | 894 | Documentazione: GUIDA AGGIORNAMENTI. |
...
| `Frontend/public/assets/js/modules/azienda/company-profile-ui.js` | JS | 16905 | 175 | Flusso aziende/account aziendali: company-profile-ui. |
...
| `docs/AUDIT_VAULT_SESSION_P0.md` | MD | 157147 | 900 | Documentazione: AUDIT VAULT SESSION P0. |
| `docs/AUDIT_VAULT_SESSION_P0.md` | MD | 157147 | 900 | Documentazione: AUDIT VAULT SESSION P0. |
| `docs/AUDIT_VAULT_SESSION_P0.md` | MD | 157147 | 900 | Documentazione: AUDIT VAULT SESSION P0. |
...
| `docs/PIANO_MATURITA_PROFESSIONALE.md` | MD | 54483 | 523 | Documentazione: PIANO MATURITA PROFESSIONALE. |
| `docs/PIANO_MATURITA_PROFESSIONALE.md` | MD | 54483 | 523 | Documentazione: PIANO MATURITA PROFESSIONALE. |
| `docs/PIANO_MATURITA_PROFESSIONALE.md` | MD | 54483 | 523 | Documentazione: PIANO MATURITA PROFESSIONALE. |
...
| File | Tipo | Byte | Righe | Responsabilità |
|---|---:|---:|---:|---|
| `package.json` | JSON | 9854 | 85 | Comandi di audit, test e versione; dipendenze di sviluppo della radice. |
| `package.json` | JSON | 9854 | 85 | Comandi di audit, test e versione; dipendenze di sviluppo della radice. |
| `package.json` | JSON | 9854 | 85 | Comandi di audit, test e versione; dipendenze di sviluppo della radice. |
...
| `scripts/run-vault-session-emulators.mjs` | MJS | 2209 | 25 | Strumento manutenzione/test: run-vault-session-emulators. |
...
| `tests/account-page-lifecycle.test.mjs` | MJS | 17240 | 278 | Test automatico: account-page-lifecycle.test. |
...
| `tests/vault-logout.test.mjs` | MJS | 4895 | 97 | Test automatico: vault-logout.test. |
...
- `Frontend/public/assets/js/auth.js` = `Frontend/public/assets/js/auth.js` = `Frontend/public/assets/js/auth.js`
- `Frontend/public/assets/js/components-v129.js` = `Frontend/public/assets/js/components-v129.js` = `Frontend/public/assets/js/components-v129.js`
- `Frontend/public/assets/js/modules/auth/imposta_nuova_password.js` = `Frontend/public/assets/js/modules/auth/imposta_nuova_password.js` = `Frontend/public/assets/js/modules/auth/imposta_nuova_password.js`
- `Frontend/public/assets/js/modules/azienda/account_azienda.js` = `Frontend/public/assets/js/modules/azienda/account_azienda.js` = `Frontend/public/assets/js/modules/azienda/account_azienda.js`
...
- `Frontend/public/assets/js/modules/privato/account_privati.js` = `Frontend/public/assets/js/modules/privato/account_privati.js` = `Frontend/public/assets/js/modules/privato/account_privati.js`
...
- `Frontend/public/assets/js/modules/privato/profilo_privato.js` = `Frontend/public/assets/js/modules/privato/profilo_privato.js` = `Frontend/public/assets/js/modules/privato/profilo_privato.js`
...
- `Frontend/public/assets/js/modules/settings/backup-export-service.js` = `Frontend/public/assets/js/modules/settings/backup-export-service.js` = `Frontend/public/assets/js/modules/settings/backup-export-service.js`
...
- `Frontend/public/assets/js/offline-sync.js` = `Frontend/public/assets/js/offline-sync.js` = `Frontend/public/assets/js/offline-sync.js`
- `archive/home-experiments/home-v126.html` = `archive/home-experiments/home-v127.html`
- `docs/AUDIT_VAULT_SESSION_P0.md` = `docs/AUDIT_VAULT_SESSION_P0.md` = `docs/AUDIT_VAULT_SESSION_P0.md`
- `docs/PAGE_PERFORMANCE_BASELINE.md` = `docs/PAGE_PERFORMANCE_BASELINE.md` = `docs/PAGE_PERFORMANCE_BASELINE.md`
- `docs/PIANO_MATURITA_PROFESSIONALE.md` = `docs/PIANO_MATURITA_PROFESSIONALE.md` = `docs/PIANO_MATURITA_PROFESSIONALE.md`
- `package.json` = `package.json` = `package.json`
- `tests/company-detail-freshness.test.mjs` = `tests/company-detail-freshness.test.mjs` = `tests/company-detail-freshness.test.mjs`
- `tests/private-bootstrap-offline.test.mjs` = `tests/private-bootstrap-offline.test.mjs`
