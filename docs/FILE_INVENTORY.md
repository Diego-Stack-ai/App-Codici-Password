...
File censiti: **539**. Duplicati byte-per-byte: **1 gruppi**.

## tests

| File | Tipo | Byte | Righe | Responsabilità |
|---|---:|---:|---:|---|
| `tests/backup-export-session.test.mjs` | MJS | 4484 | 62 | Test automatico: backup-export-session.test. |
...
| `tests/backup-restore-ui.test.mjs` | MJS | 18036 | 257 | Test automatico: backup-restore-ui.test. |
...
| `Frontend/GUIDA_AGGIORNAMENTI.md` | MD | 77405 | 738 | Documentazione: GUIDA AGGIORNAMENTI. |
...
| `Frontend/public/assets/js/modules/settings/backup-export-service.js` | JS | 9254 | 200 | Impostazioni applicative: backup-export-service. |
...
| `Frontend/public/assets/js/modules/settings/impostazioni.js` | JS | 64160 | 1273 | Impostazioni applicative: impostazioni. |
...
| `docs/AUDIT_VAULT_SESSION_P0.md` | MD | 130173 | 735 | Documentazione: AUDIT VAULT SESSION P0. |
...
| `docs/M8_BACKUP_RECUPERO.md` | MD | 20513 | 148 | Documentazione: M8 BACKUP RECUPERO. |
...
| `docs/PIANO_MATURITA_PROFESSIONALE.md` | MD | 37846 | 427 | Documentazione: PIANO MATURITA PROFESSIONALE. |
...
| `experiments/offline-sync/browser-backend-sync.mjs` | MJS | 18225 | 223 | File di progetto: browser-backend-sync. |
...
| `experiments/offline-sync/fenced-queue-client.mjs` | MJS | 5530 | 91 | File di progetto: fenced-queue-client. |
...
| `experiments/offline-sync/run-browser-tests.mjs` | MJS | 5429 | 77 | File di progetto: run-browser-tests. |
