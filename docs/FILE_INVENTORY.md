...
File censiti: **712**. Duplicati byte-per-byte: **1 gruppi**.

## experiments

| File | Tipo | Byte | Righe | Responsabilità |
|---|---:|---:|---:|---|
| `experiments/persistent-vault-shell/company-contacts-contract.mjs` | MJS | 5738 | 93 | File di progetto: company-contacts-contract. |
| `experiments/persistent-vault-shell/company-contacts-contract.test.mjs` | MJS | 6571 | 103 | File di progetto: company-contacts-contract.test. |
...
| `docs/DEEPSEEK_COORDINATION.md` | MD | 73150 | 407 | Documentazione: DEEPSEEK COORDINATION. |
...
| File | Tipo | Byte | Righe | Responsabilità |
|---|---:|---:|---:|---|
| `package.json` | JSON | 14568 | 97 | Comandi di audit, test e versione; dipendenze di sviluppo della radice. |
