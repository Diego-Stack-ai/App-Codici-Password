...
| `Frontend/GUIDA_AGGIORNAMENTI.md` | MD | 76530 | 730 | Documentazione: GUIDA AGGIORNAMENTI. |
...
| `docs/AUDIT_VAULT_SESSION_P0.md` | MD | 128319 | 723 | Documentazione: AUDIT VAULT SESSION P0. |
...
| `docs/M6_SINCRONIZZAZIONE_OFFLINE.md` | MD | 37469 | 240 | Documentazione: M6 SINCRONIZZAZIONE OFFLINE. |
...
| `docs/PIANO_MATURITA_PROFESSIONALE.md` | MD | 37072 | 423 | Documentazione: PIANO MATURITA PROFESSIONALE. |
...
| `experiments/offline-sync/browser-backend-sync.mjs` | MJS | 15413 | 187 | File di progetto: browser-backend-sync. |
...
| `experiments/offline-sync/fenced-queue-client.mjs` | MJS | 4827 | 79 | File di progetto: fenced-queue-client. |
...
| `experiments/offline-sync/offline-save-panel.mjs` | MJS | 15296 | 210 | File di progetto: offline-save-panel. |
| `experiments/offline-sync/offline-save-panel.test.mjs` | MJS | 13981 | 225 | File di progetto: offline-save-panel.test. |
...
| File | Tipo | Byte | Righe | Responsabilità |
|---|---:|---:|---:|---|
| `package.json` | JSON | 9348 | 84 | Comandi di audit, test e versione; dipendenze di sviluppo della radice. |
