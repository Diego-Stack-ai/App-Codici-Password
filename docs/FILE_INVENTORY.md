...
| `Frontend/GUIDA_AGGIORNAMENTI.md` | MD | 130916 | 1001 | Documentazione: GUIDA AGGIORNAMENTI. |
...
| `docs/DEEPSEEK_COORDINATION.md` | MD | 28044 | 213 | Documentazione: DEEPSEEK COORDINATION. |
| `docs/DS-002A_ALLEGATI_DOCUMENTI_CONTRATTO.md` | MD | 21396 | 130 | Documentazione: DS-002A ALLEGATI DOCUMENTI CONTRATTO. |
...
| `docs/PIANO_MATURITA_PROFESSIONALE.md` | MD | 90390 | 654 | Documentazione: PIANO MATURITA PROFESSIONALE. |
| `docs/PROFILO_ACCOUNT_WIDGET_CACHE_ROADMAP.md` | MD | 113671 | 692 | Documentazione: PROFILO ACCOUNT WIDGET CACHE ROADMAP. |
...
| `experiments/persistent-vault-shell/profile-document-attachments-contract.mjs` | MJS | 18601 | 251 | File di progetto: profile-document-attachments-contract. |
| `experiments/persistent-vault-shell/profile-document-attachments-handler.mjs` | MJS | 30866 | 450 | File di progetto: profile-document-attachments-handler. |
| `experiments/persistent-vault-shell/profile-document-attachments-handler.test.mjs` | MJS | 32839 | 494 | File di progetto: profile-document-attachments-handler.test. |
