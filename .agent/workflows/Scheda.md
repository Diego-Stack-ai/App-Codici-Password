...
Dopo che l’invito è accettato:

appare un pulsante “Annulla condivisione”

questo pulsante vale sia per:

proprietario

invitato (utente che ha accettato)

Quando viene annullata la