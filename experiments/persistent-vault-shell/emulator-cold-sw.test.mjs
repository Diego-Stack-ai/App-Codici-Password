...
test('cold laboratory installation caches only the exact static allowlist', async () => {
    ...
    await installed;
    assert.deepEqual(added, ['/company-summary-pdf.js', '/assets/pdf/LiberationSans-Regular.ttf', '/assets/pdf/LiberationSans-Bold.ttf', '/assets/js/vendor/qrcode.min.js', '/', '/emulator.js', '/emulator.css', '/entry-check.mjs', '/symbols.woff2', '/assets/images/google-avatar.png']);
});
