...
export async function probeOfflineConsultation({context, getUser}) {
    ...
    const samples = [
        ...
        ['phone contact', profile.contactPhones[0].value, '000000000'],
        ['address', profile.userAddresses[0].street, 'Via fittizia'],
        ['document metadata', profile.documenti[0].numero, 'DOC-FITTIZIO'],
