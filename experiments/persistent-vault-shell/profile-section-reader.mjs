// Explicit projection of canonical profile fields. No credentials, photos or files.
const fields = {
...
export function createProfileSectionReader({context, getUser, repository, isEncryptedValue}) {
    ...
    return async section => {
        ...
        const rows = [];
        async function project(item, shape, group) {
