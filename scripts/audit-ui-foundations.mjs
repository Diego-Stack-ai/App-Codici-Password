...
const requiredSignals = [
  ...
  ,['fasce chiare sfumate e non azzurre', /--fixed-header-bg:\s*linear-gradient\(to bottom, rgba\(255, 255, 255/.test(core) && /--fixed-footer-bg:\s*linear-gradient\(to top, rgba\(255, 255, 255/.test(core)]
