...
const requiredSignals = [
  ...
  ,['fasce mobile con sfumatura storica', /\.base-header \{[\s\S]+background:\s*linear-gradient\(to bottom, var\(--card-bg\) 0%, var\(--card-bg\) 68%, transparent 100%\)/.test(fixedBars) && /\.base-footer \{[\s\S]+background:\s*linear-gradient\(to top, var\(--card-bg\) 0%, var\(--card-bg\) 58%, transparent 100%\)/.test(fixedBars)]
