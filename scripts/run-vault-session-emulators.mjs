...
if (process.argv.length > 3 || process.argv.slice(2).some(arg => !['--browser', '--mutation', '--fenced-browser', '--entry-browser', '--cold-browser'].includes(arg))) throw new Error('INVALID_ARGUMENT');
