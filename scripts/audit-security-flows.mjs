...
assert.match(homeHtml, /data-app-version>v1\.1\.7</, 'La home non mostra una versione di fallback durante l’aggiornamento cache');
...
assert.match(homeHtml, /main\.js\?v=1\.1\.7/, 'La home non forza il caricamento della release corrente');
...
assert.match(loginHtml, /main\.js\?v=1\.1\.7/, 'Il login non forza la release JavaScript corrente');
