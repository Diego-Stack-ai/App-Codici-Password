const CACHE_NAME = 'codex-shell-v1.2.34';
...
const APP_SHELL = [
    'login-v115.html',
    'home_page.html',
    'manifest.json?v=1.2.34',
    'assets/images/app-icon.jpg',
    'assets/images/app-icon-192.png',
    'assets/images/app-icon-512.png',
    'assets/images/app-icon-maskable-512.png',
    'assets/images/apple-touch-icon-180.png',
    'assets/css/core.css?v=1.2.34',
    'assets/css/core_ui.css?v=1.2.34',
    'assets/css/core_fonts.css',
    'assets/css/core_fascie.css',
    'assets/css/core_pagine.css?v=1.2.34',
    'assets/css/home_page.css?v=1.2.34',
    'assets/css/accesso.css?v=1.2.34',
    'assets/css/vault-assistant.css?v=1.2.34',
    'assets/js/theme-init.js',
    'assets/js/home-bootstrap.js?v=1.2.34',
    'assets/js/login-entry.js?v=1.2.34',
    'assets/js/main-v129.js',
    'assets/js/components-v129.js',
    'assets/js/ui-core-v129.js',
    'assets/js/env-v126.js',
    'assets/js/firebase-config.js?v=1.2.34',
    'assets/js/auth.js?v=1.2.34',
    'assets/js/modules/auth/login.js?v=1.2.34',
    ...
    'assets/js/pages-init.js?v=1.2.34',
    'assets/js/modules/home/home.js?v=1.2.34',
    'assets/js/modules/privato/area_privata.js?v=1.2.34',
    'assets/js/modules/assistant/conversation-engine.js?v=1.2.34',
