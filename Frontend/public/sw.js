const CACHE_NAME = 'codex-shell-v1.2.28';
...
const APP_SHELL = [
    ...
    'assets/css/accesso.css?v=5.0-ai5',
    'assets/css/vault-assistant.css?v=1.2.25-ai12',
    'assets/js/theme-init.js',
    'assets/js/login-entry.js?v=1.3.3-ai5',
    ...
    'assets/js/modules/auth/login.js?v=1.3.3-ai5',
    ...
    'assets/js/pages-init.js?v=1.2.25-ai12',
    'assets/js/modules/home/home.js?v=1.2.25-ai12',
    'assets/js/modules/assistant/conversation-engine.js?v=1.2.25-ai12',
