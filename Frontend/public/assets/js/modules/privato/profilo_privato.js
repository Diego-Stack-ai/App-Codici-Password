...
import { auth, db, storage } from '../../firebase-config.js?v=1.2.65';
...
import { initAddressesDocsModule, renderAddressesView, renderDocumentiView } from './profilo-addresses-docs.js?v=1.2.65';
