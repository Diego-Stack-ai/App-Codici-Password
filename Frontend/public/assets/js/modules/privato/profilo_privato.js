...
import { auth, db, storage } from '../../firebase-config.js?v=1.2.128';
...
import { initAddressesDocsModule, renderAddressesView, renderDocumentiView } from './profilo-addresses-docs.js?v=1.2.128';
...
async function loadUserData(user, renderImmediately = true) {
    try {
        ...
        const { readErrorMessage } = await import('../shared/read-error-message.js');
