...
import { auth, db, storage } from '../../firebase-config.js?v=1.2.39';
...
import { initAddressesDocsModule, renderAddressesView, renderDocumentiView } from './profilo-addresses-docs-v2.js?v=1.2.39';
