...
import { auth, db, storage } from '../../firebase-config.js?v=1.2.46';
...
import { initAddressesDocsModule, renderAddressesView, renderDocumentiView } from './profilo-addresses-docs-v2.js?v=1.2.46';
