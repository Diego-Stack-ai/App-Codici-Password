...
import { VaultConversationEngine } from './conversation-engine.js?v=1.2.104';
import { createAssistantUI } from './assistant-ui.js?v=1.2.104';
...
function attachStyles() {
    ...
    link.rel = 'stylesheet'; link.href = '/assets/css/vault-assistant.css?v=1.2.104'; link.dataset.vaultAssistant = 'true';
