...
async function loadAccount() {
    try {
        ...
        import('../shared/account-shared-credentials.js?v=1.2.119').then(({initAccountSharedCredentials}) =>
        ...
        import('../shared/account-embedded-widgets.js?v=1.2.119').then(({initAccountEmbeddedWidgets}) =>
