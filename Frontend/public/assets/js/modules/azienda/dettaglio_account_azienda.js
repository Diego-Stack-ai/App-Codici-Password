...
import { db } from '../../firebase-config.js?v=1.2.112';
...
async function loadAccount() {
    try {
        ...
        import('../shared/account-shared-credentials.js?v=1.2.112').then(({initAccountSharedCredentials}) =>
        ...
        import('../shared/account-embedded-widgets.js?v=1.2.112').then(({initAccountEmbeddedWidgets}) =>
