...
async function loadAccount() {
    try {
        ...
        import('../shared/account-shared-credentials.js?v=1.2.120').then(({initAccountSharedCredentials}) =>
        ...
        import('../shared/account-embedded-widgets.js?v=1.2.120').then(({initAccountEmbeddedWidgets}) =>
