...
export async function initComponents() {
    ...
    try {
        ...
        const isHome = path.endsWith('home_page.html') || path.endsWith('home-v126.html');
        ...
        if (headerPh) {
            ...
            if (isHome) {
                ...
                if (path.endsWith('lista_aziende.html') || path.endsWith('scadenze.html')) {
                    backFn = () => window.location.replace('home-v126.html');
            ...
            if (!isAuth) {
                ...
                if (isHome) {
                    ...
                    headerRight.appendChild(
                        createElement('a', { href: 'home-v126.html', className: 'btn-icon-header' }, [
