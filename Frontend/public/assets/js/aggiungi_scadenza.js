    ...
    const interval = setInterval(() => {
        ...
        if (footerRight) {
            ...
            footerRight.innerHTML = `
                <button id="save-btn" class="base-btn-primary flex-center-gap" title="Salva Scadenza">
                    <span class="material-symbols-outlined">save</span>
                    <span data-t="save_deadline">Salva</span>
                </button>
            `;
            setupSaveLogic();
        }
...
function populateTypeSelect() {
    ...
    typeSelect.innerHTML = '<option value="">Scelgli categoria...</option>';
