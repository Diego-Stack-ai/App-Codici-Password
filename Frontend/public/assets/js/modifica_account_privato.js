            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="flex flex-col gap-1.5">
                    ...
                    <div class="flex items-center bg-white dark:bg-slate-900/50 rounded-xl border border-black/5 dark:border-white/10 overflow-hidden focus-within:ring-1 focus-within:ring-primary/20 transition-all">
                        <input type="password" class="dispositiva-input w-full bg-transparent border-none h-11 px-4 text-sm focus:ring-0 dark:text-white" 
            ...
            <div class="grid grid-cols-1 gap-4">
                ...
                <div class="grid grid-cols-3 gap-3">
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <input type="text" class="pin-input w-full bg-slate-50 dark:bg-slate-800 border-none rounded-lg h-10 px-3 text-sm text-[#0A162A] dark:text-white focus:ring-1 focus:ring-primary/20" 
