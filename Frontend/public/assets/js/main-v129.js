 ...
 */
import * as firebaseRuntime from './firebase-config.js?v=1.2.92';
...
import * as Pages from './pages-init.js?v=1.2.92&push=20260908b&deadline-share=20260908a';
            ...
            try {
                ...
                if (isPrivatePage && assistantEnabled) {
                    try {
                        ...
                        const { initVaultAssistant } = await import('./modules/assistant/assistant-controller.js?v=1.2.92');
